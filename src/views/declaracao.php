...
<body>
    ...
    <main class="content">
        ...
        <p>Declaro, para os devidos fins, junto a ________________________________________________, que
            ...
            residente e domiciliado na <strong><?= $aluno[0]->logradouro ?></strong>, <strong><?= $aluno[0]->numero ?></strong>,
            <strong><?= $aluno[0]->bairro ?></strong>, <strong><?= $aluno[0]->cidade ?></strong>/<strong><?= $aluno[0]->estado ?></strong>, encontra-se devidamente
